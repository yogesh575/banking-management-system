...
function Header()
{
    ...
    $this->Cell(80);
    // Title
    $this->Cell(80,10,'payment Details',1,0,'C');
    // Line break
    $this->Ln(20);
}
...
$result = mysqli_query($conn,"SELECT hid,amount,balance,time,type FROM  history order by hid desc  limit 1 ") or die("database error:". mysqli_error($conn));
